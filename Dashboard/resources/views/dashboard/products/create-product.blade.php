    ...
    <div class="col-12">
        <form action="{{ route('dashboard.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row my-3">
                <div class="col-4">
                    <input type="number" class="form-control" value="{{ old('code') }}" name="code" placeholder="code">
                </div>
                <div class="col-4">
                ...
                <div class="col-4">
                    ...
                    <select name="brand_id" id="brand_id" class="form-control">
                        @foreach ($brands as $brand)
                            <option @selected(old('subcategory_id') === "$brand->id") value="{{ $brand->id }}">{{ $brand->name_en }}
                            </option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-row my-3">
                ...
                <div class="col-6">
                    <textarea name="details_ar" id="" cols="30" class="form-control" rows="10" placeholder="Details In Arabic">
                        {{ old('details_ar') }}
                    </textarea>
                </div>
            </div>
