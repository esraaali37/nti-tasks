...
@section('title', 'Edit')
@section('content')
 @include('includes.display-error-mesaage')
    <div class="col-12">
        <form action="{{ route('dashboard.products.update',['id'=>$product->id])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="col-6 my-3">
                    <input type="text" class="form-control" name="name_en" value="{{$product->name_en}}" placeholder="Name in English">
                </div>
                <div class="col-6">
                    <input type="text" class="form-control" name="name_ar" value="{{$product->name_ar}}" placeholder="Name in Arabic">
                </div>
            </div>
            <div class="form-row my-3">
                <div class="col-4">
                    <input type="number" class="form-control" name="code" value="{{$product->code}}" placeholder="code">
                </div>
                <div class="col-4">
            ...
            <div class="form-row my-3">
                ...
                <div class="col-6">
                    <textarea name="details_ar" id="" cols="30" class="form-control" rows="10"
                     placeholder="Details In Arabic">
                     {{$product->details_ar}}</textarea>
                </div>
            </div>
            <div class="form-row my-3">
                <div class="col-12">
                ...
                <div class="col-4">
                    ...
                    alt="{{$product->name_en}}" class="w-100">
                </div>
            </div>
            <div class="form-row">
