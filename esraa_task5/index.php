...
$mostNewProduct = $newProduct->setStatus(ACTIVE)->getMostProducts();
$orderProduct = new Product;
$mostproductOrder = $orderProduct->setStatus(ACTIVE)->getMostOrder();
$mostReated = new Product;
$mostReatedProduct = $mostReated->mostReatedProduct();
?>
<!-- Slider Start -->
    ...
    <div class="container">
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Most New Products</h3>
                <div class="row mt-5">
                <?php if ($mostNewProduct->num_rows >= 1) {
                $NewProducts = $mostNewProduct->fetch_all(MYSQLI_ASSOC);
                foreach ($NewProducts as $index =>$NewProduct) {   
                   ?>
                    <div class="col-3">
                        <div class="product-img">
                                <a href="product-details.php?id=<?= $NewProduct['id'] ?>">
                                <img alt="" src="assets/img/product/<?= $NewProduct['image'] ?>">
                            </a>
                        </div>
                        <div class="product-content text-left">
                            <div class="product-hover-style">
                                <div class="product-title">
                                    <h4>
                                        <a href="product-details.php?id=<?= $NewProduct['id'] ?>"><?= $NewProduct['name_en'] ?></a>
                                    </h4>
                                </div>
...
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <!--most ordered products SRART -->
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Most Ordered Products</h3>
                <div class="row mt-5">
                <?php if ($mostproductOrder->num_rows >= 1) {
                $mostproductOrders = $mostproductOrder->fetch_all(MYSQLI_ASSOC);
                foreach ($mostproductOrders as $index => $mostproductOrderr) {   
                   ?>    
                    <div class="col-3">
                        <div class="product-img">
                                 <a href="product-details.php?id=<?= $mostproductOrderr['proder_id'] ?>"> 
                                <img alt="" src="assets/img/product/<?= $mostproductOrderr['image'] ?>">
                            </a>
                        </div>
                        <div class="product-content text-left">
                            <div class="product-hover-style">
                                <div class="product-title">
                                    <h4>
                                        <a href="product-details.php?id=<?= $mostproductOrderr['order_id'] ?>"><?= $mostproductOrderr['name_en'] ?></a>
                                    </h4>
                                </div>
...
<!--most rated products SRART -->
<div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Most Rated products SRART</h3>
                <div class="row mt-5">
                <?php if ($mostReatedProduct->num_rows >= 1) {
                $ReatedProductMosts = $mostReatedProduct->fetch_all(MYSQLI_ASSOC);
                foreach ($ReatedProductMosts as $index => $ReatedProductMost) {   
                   ?>    
                    <div class="col-3">
                        <div class="product-img">
                                 <a href="product-details.php?id=<?= $ReatedProductMost['product_id'] ?>"> 
                                <img alt="" src="assets/img/product/<?= $ReatedProductMost['image'] ?>">
                            </a>
                        </div>
                        <div class="product-content text-left">
                            <div class="product-hover-style">
                                <div class="product-title">
                                    <h4>
                                        <a href="product-details.php?id=<?= $ReatedProductMost['product_id'] ?>"><?= $ReatedProductMost['name_en'] ?></a>
                                    </h4>
                                </div>
