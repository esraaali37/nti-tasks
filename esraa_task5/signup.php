...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    $errors = [];
    $registerRequest->setFirstName($_POST['first_name']);
     $registerRequest->firstNameValidation();
     $registerRequest->setLastName($_POST['last_name']);
     $registerRequest->lastNameValidation();
    ...
    if(empty($registerRequest->errors())){
        ...
        if($result){
            ...
            // dd($verificationMailResult);
            if($verificationMailResult){
                $_SESSION['email'] = $_POST['email'];
                header('location:checkcode.php?page=signup');die;
            }else{
                            ...
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    ...
                                    <form  method="post">
                                        ...
                                        <?= $registerRequest->getErrorMessage('first_name') ?>
                                        <input type="text" name="last_name" placeholder="Last Name" value="<?= old('last_name') ?>">
                                        <?= $registerRequest->getErrorMessage('last_name') ?>
                                        ...
                                        <select name="gender" class="form-control">
                                            <option <?= old('gender') == 'm' ? 'selecte' : '' ?> value="m">Male</option>
                                            <option <?= old('gender') == 'f' ? 'selecte' : '' ?> value="f">Female</option>
                                        </select>
