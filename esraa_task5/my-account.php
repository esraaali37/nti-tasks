    ...
    if (isset($_POST['update-profile'])) {
        ...
        if (empty($changeEmailRequest->errors())) {
            ...
            if ($result) {
                ...
                $body = "<div> <p> Hello {$_POST['email']} </p> <p> Your Verification Code
                        :<strong>{$verificationCode}</strong></p> <p> Please Verify Your Email Address
                         Before Code Expiration</p> <p> Thank you.</p> </div>";
                ...
                if ($verificationMailResult) {
                    ...
                    header('location:logout.php?page=checkcode.php?page=my-account');
                    die;
                } else {
