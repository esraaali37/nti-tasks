...
$categoriesResult = $categoriesInstance->getWebsiteCategory();
                ...
                <div class="col-lg-9 col-md-8 col-6">
                    <div class="header-bottom-right">
                                                ...
                                                foreach ($categories as $category) { ?>
                                                    <li>
                                                        <ul>
                                                            ...
                                                            <?php 
                                                                $subcategoriesResult = $subcategoryInstance->setCategorieId($category['id'] )
                        ...
                        <?php  } else { ?>
                            <div class="header-currency">
                                <span class="digit">
                            <?= ucfirst("{$_SESSION['user']->first_name} {$_SESSION['user']->last_name}") ?> 
