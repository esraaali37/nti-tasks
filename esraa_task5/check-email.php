...
define('CODE_EXPIRATION_PERIOD_IN_MINUTES',3);
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(empty($emailVerificationRequest->errors())){
        ...
        if($result->num_rows == 1){
            ...
            $updateCodeResult = $userObject->setForgetCode($forgetCode)->setCode_expired_at($forgetCodeExpiration)->updateForgetCode();
            if($updateCodeResult){
                // send mail
                ...
                if($verificationMailResult){
                    ...
                    header('location:checkcode.php?page=check-email');die;
                }else{
